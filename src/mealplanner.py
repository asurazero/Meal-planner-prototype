...
class Tools(Screen,MDApp):
    def checkrecipedata(self):
        fulldatabasechklist=[]
        fulldatabasechklist+=ent_rec_comp
        fulldatabasechklist+=side_rec_comp
        fulldatabasechklist+=salad_rec_comp
        fulldatabasechklist+=des_rec_comp
        fulldatabasechklist+=brk_rec_comp
        fulldatabasechklist+=mex_rec_comp
        fulldatabasechklist+=fsh_rec_comp
        fulldatabasechklist+=brd_rec_comp
        badrecipegrabs=[]

        for recipe_get in  fulldatabasechklist:
            try:
                with open(f"recipes/{recipe_get}.txt", "r") as recipe_pull:
                    continue
                ...
                badrecipegrabs.extend(recipe_get)
                print("failed to get recipe")
                print(fulldatabasechklist)
                print(badrecipegrabs)
                continue
...
class WebScrapeReportPop(Popup):
    pass
class DatabaseTester(Screen,MDApp):
    pass
